...
rm -r /var/www/hri.unica.it/data/publications/*.json

echo "{
  \"nJson\": $ceil
}" > /var/www/hri.unica.it/data/publications/nJson.json
...
do
  ...
  echo $json > "/var/www/hri.unica.it/data/publications/file$i.json"
done
